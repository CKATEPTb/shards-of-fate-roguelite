...
export function LoadoutIcon({ kind }: { kind: LoadoutIconKind }) {
  const shapes = {
    ...
    rightHand: <><path d="M10 24 6 16c-1-3 2-4 3-1l1 2V7c0-2 3-2 3 0v6-9c0-2 3-2 3 0v9-7c0-2 3-2 3 0v8-4c0-2 3-2 3 0v8l-3 6Z" /><path d="M10 21h10" /></>,
    leftHand: <g transform="translate(28 0) scale(-1 1)"><path d="M10 24 6 16c-1-3 2-4 3-1l1 2V7c0-2 3-2 3 0v6-9c0-2 3-2 3 0v9-7c0-2 3-2 3 0v8-4c0-2 3-2 3 0v8l-3 6Z" /><path d="M10 21h10" /></g>,
