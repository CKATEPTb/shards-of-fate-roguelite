...
import { actOneCatalogEnemies, tagLegacyActOneEnemy } from './enemy-catalog';
import { actOneBosses } from './boss-catalog';

const legacyEnemies: EnemyDefinition[] = [
  {
    schemaVersion: 1, id: 'rat', name: 'Лесная крыса', title: 'Стая', description: 'Мелкий проворный зверёк. Опасен числом.',
    role: 'damage', rank: 'SWARM', encounterCost: 1, level: 1, color: '#ad9280', sprite: 'rat',
    stats: { maxHp: 12, power: 4, armor: 1, initiative: 5, crit: 1, evasion: 2, agility: 4 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'damage', rank: 'NORMAL', encounterCost: 2, level: 2, color: '#c0c8c6', sprite: 'wolf',
    stats: { maxHp: 22, power: 7, armor: 3, initiative: 4, crit: 2, evasion: 2, agility: 4 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'tank', rank: 'NORMAL', encounterCost: 2, level: 1, color: '#86c58a', sprite: 'slime',
    stats: { maxHp: 25, power: 5, armor: 8, initiative: 0, crit: 0, evasion: 1, agility: 0 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'damage', rank: 'NORMAL', encounterCost: 2, level: 2, color: '#b58dba', sprite: 'spider',
    stats: { maxHp: 17, power: 6, armor: 3, initiative: 4, crit: 1, evasion: 2, agility: 4 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'damage', rank: 'NORMAL', encounterCost: 2, level: 2, color: '#a6bd70', sprite: 'goblin_scout',
    stats: { maxHp: 22, power: 7, armor: 5, initiative: 3, crit: 2, evasion: 2, agility: 3 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'damage', rank: 'VETERAN', encounterCost: 3, level: 3, color: '#d3a66a', sprite: 'goblin_archer',
    stats: { maxHp: 20, power: 8, armor: 4, initiative: 3, crit: 2, evasion: 2, agility: 3 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'healer', rank: 'VETERAN', encounterCost: 3, level: 3, color: '#bc9bdf', sprite: 'goblin_shaman',
    stats: { maxHp: 25, power: 8, armor: 4, initiative: 1, crit: 1, evasion: 1, agility: 1 , accuracy: 0, resilience: 0, luck: 0 },
  ...
  },
  {
    ...
    role: 'tank', rank: 'VETERAN', encounterCost: 3, level: 3, color: '#b58369', sprite: 'boar',
    stats: { maxHp: 43, power: 11, armor: 12, initiative: 1, crit: 1, evasion: 1, agility: 1 , accuracy: 0, resilience: 0, luck: 0 },
    basicAttack: { type: 'damage', dice: '1d8', scaling: 'power', factor: 0.6 },
  ...
  },
  {
    ...
    role: 'tank', rank: 'NORMAL', encounterCost: 2, level: 2, color: '#77ab72', sprite: 'thornling',
    stats: { maxHp: 30, power: 7, armor: 13, initiative: 0, crit: 1, evasion: 1, agility: 0 , accuracy: 0, resilience: 0, luck: 0 },
    basicAttack: { type: 'damage', dice: '1d6', scaling: 'power', factor: 0.6 },
  ...
  },
  {
    ...
    role: 'tank', rank: 'ELITE', encounterCost: 7, level: 5, color: '#d2c88b', sprite: 'elite_warden',
    stats: { maxHp: 100, power: 14, armor: 17, initiative: 2, crit: 2, evasion: 1, agility: 2 , accuracy: 0, resilience: 0, luck: 0 },
...
/** The original ten keep their combat definitions and stable IDs. */
export const enemies: EnemyDefinition[] = [...legacyEnemies.map(tagLegacyActOneEnemy), ...actOneCatalogEnemies, ...actOneBosses];
